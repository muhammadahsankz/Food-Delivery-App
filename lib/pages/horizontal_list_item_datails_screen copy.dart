...
class HorizontalListItemDetailsScreen extends StatefulWidget {
  final dynamic data;
  const HorizontalListItemDetailsScreen({super.key, required this.data});

  @override
  State<HorizontalListItemDetailsScreen> createState() =>
      _HorizontalListItemDetailsScreenState();
}

class _HorizontalListItemDetailsScreenState
    extends State<HorizontalListItemDetailsScreen> {
  double totalPrice = 0;
  int quantity = 1;
  String? id;
